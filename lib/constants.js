export const API_URL = 'https://api-v3.thaiwater.net/api/v1/thaiwater30/public/waterlevel_load';
...
export const SNAPSHOT_DATA = [
  ...
  },
  {
    ...
    station: {
      tele_station_name: { th: 'สะพานข้ามคลองอู่ตะเภา', en: 'Khlong U Taphao Bridge' },
      min_bank: 0.84,
      ground_level: -4.515,
    },
...
export const FETCH_ROUTES = [
  { url: API_URL, parse: 'json' },
  { url: 'https://api.codetabs.com/v1/proxy?quest=' + encodeURIComponent(API_URL), parse: 'json' },
  { url: 'https://api.allorigins.win/get?url=' + encodeURIComponent(API_URL), parse: 'allorigins' },
  { url: 'https://corsproxy.io/?url=' + encodeURIComponent(API_URL), parse: 'json' },
];